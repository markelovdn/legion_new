...
<main id="js-page-content" role="main" class="page-content mt-3">
    ...
    <div class="row">
        <div class="col-xl-12">
           @can('can-add-user', $users)
                    <a class="btn btn-success" href="{{ route('createuser') }}">Добавить</a>
            @endcan
                        ...
                        <div class="d-flex flex-row align-items-center">
                            @switch($user['status'])
                                ...
                                @case ($user['status'] == 3)
                                    ...
                                    @break
                                @endswitch
                                    <span class="rounded-circle profile-image d-block " style="background-image:url({{'/uploads/'.''.$user['photo']}}); background-size: cover;"></span>
                                </span>
                            ...
                            <div class="info-card-text flex-1">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="/general/{{$user['id']}}">
                                    ...
                                    <a href="/delUser/{{$user['id']}}" class="dropdown-item" onclick="return confirm('are you sure?');">
